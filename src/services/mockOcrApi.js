// src/services/mockOcrApi.js
// This is a simple Express server to mock the OCR API for local development
...
// Start the server
app.listen(PORT, () => {
  console.log(`Mock OCR API server running on port ${PORT}`);
